...
Previous work~\cite{} has shown the \gls{NLL} to be a proper scoring rule, which intuitively means that it provides a quantitative assessment of the \gls{UQ} and that it can be decomposed into terms that relate to both calibration and sharpness.
% TODO:  [Willie] Find a citation for this
\gls{NLL} is also a popular performance metric that has been used to quantify uncertainty in a variety of prior work~\cite{} and provides an additional single score for \gls{UQ} methods.
% TODO:  [Willie] Find a citation for this
