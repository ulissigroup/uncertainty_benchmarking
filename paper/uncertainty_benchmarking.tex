...
%Some of the performance metrics for predictive \gls{UQ} are agnostic to
%prediction performance---they provide an assessment of the uncertainty
%independent of the predictive accuracy (i.e. a method can predict badly, but
%could still accurately quantify its own uncertainty).
