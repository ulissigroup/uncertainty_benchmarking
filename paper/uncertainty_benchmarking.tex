...
Figure~\ref{fig:parity} contains parity plots for all \gls{UQ} methods studied here; Figure~\ref{fig:calibration} contains calibration curves; and Figure~\ref{fig:sharpness} contains distribution plots of the \gls{ML}-predicted \gls{UQ}s.
...
\begin{figure}
    ...
    \begin{subfigure}{0.32\textwidth}
        ...
        \caption{\gls{NN} ensemble}\label{fig:parity_nn}
    \end{subfigure}
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../CGCNN_ensemble/parity.pdf}  % TODO:  Make and use the real parity plot here
    ...
    Logarithm-scale shading was used to accentuate outliers.
...
\begin{figure}
    ...
    \begin{subfigure}{0.32\textwidth}
        ...
        \caption{\gls{NN} ensemble}\label{fig:calibration_nn}
    \end{subfigure}
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../CGCNN_ensemble/calibration.pdf}  % TODO:  Make and use the real calibration plot here
...
\begin{figure}
    ...
    \begin{subfigure}{0.32\textwidth}
        ...
        \caption{\gls{NN} ensemble}\label{fig:sharpness_nn}
    \end{subfigure}
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\textwidth]{../CGCNN_ensemble/sharpness.pdf}  % TODO:  Make and use the real sharpness plot here
...
Table~\ref{tab:results} summarizes all performance metrics.
...
\begin{table}
    ...
    \begin{tabular}{lrrrrrrrr}
        ...
        \gls{NN} ensemble & foo & foo & foo & foo & foo & foo & foo & foo \\
        \gls{BNN} & foo & foo & foo & foo & foo & foo & foo & foo \\
        \gls{dNN} & foo & foo & foo & foo & foo & foo & foo & foo \\
        \gls{GP} & foo & foo & foo & foo & foo & foo & foo & foo \\
        \gls{dGP} & foo & foo & foo & foo & foo & foo & foo & foo \\
        \gls{PFGP} & foo & foo & foo & foo & foo & foo & foo & foo \\
        \bottomrule
    \end{tabular}
