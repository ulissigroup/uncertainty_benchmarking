...
Previous work~\cite{Dawid2014} has shown the \gls{NLL} to be a proper scoring rule, which intuitively means that it provides a quantitative assessment of the \gls{UQ} and that it can be decomposed into terms that relate to both calibration and sharpness.
