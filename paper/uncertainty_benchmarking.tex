...
Table~\ref{tab:results} lists the performance metrics of all methods we used in this study.
...
\begin{table}
    ...
    The units of \gls{MDAE}, \gls{MAE}, \gls{RMSE}, and Sha are all in \gls{eV}.
    The units of \gls{MARPD} are in \%.}\label{tab:results}
\end{table}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Parity plots for all six \gls{UQ} methods used in this study.
